...
const whatDayIsIt = function (dayToday) {
  let daysOfWeek = [
    "Sunday",
    "Monday",
    "Tuesday",
...
const deleteProp = function (objec11, string11) {
  delete objec11[string11];
  return objec11;
};
let ex11 = deleteProp(flower, `shape`);
console.log(ex11);
